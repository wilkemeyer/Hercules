/**
 * Copyright (c) 2012, Florian Wilkemeyer <fw@f-ws.de>
 *
 * Use, distribution and modification of this source code and/or
 * resulting object code is not permitted. 
 * Expecting non-comercial usage of the resulting binary / object code.
 * All other use, distribution or modification is prohibited 
 * without written permission from Florian Wilkemeyer
 *
 * Contact Information
 *  E-Mail: fw@f-ws.de
 * 
 * This File is part of Ragnarok Online Client (roclient)
 */
#include "stdafx.h"
