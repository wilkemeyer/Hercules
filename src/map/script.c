...
void CScript::set_constant(const char *name, int value, bool is_parameter, bool is_deprecated)
{
...
void CScript::set_constant2(const char *name, int value, bool is_parameter, bool is_deprecated)
{
	int n = script->add_str(name);
...
struct map_session_data *CScript::rid2sd(struct script_state *st)
{
...
struct map_session_data *CScript::id2sd(struct script_state *st, int account_id)
{
	struct map_session_data *sd;
...
struct map_session_data *CScript::charid2sd(struct script_state *st, int char_id)
{
	struct map_session_data *sd;
...
struct map_session_data *CScript::nick2sd(struct script_state *st, const char *name)
{
	struct map_session_data *sd;
 ...
 *------------------------------------------*/
int CScript::set_reg(struct script_state *st, struct map_session_data *sd, int64 num, const char *name, const void *value, struct reg_db *ref)
{
	char prefix = name[0];
...
int CScript::set_var(struct map_session_data *sd, char *name, void *val)
{
	return script->set_reg(NULL, sd, reference_uid(script->add_str(name),0), name, val, NULL);
}

void CScript::setd_sub(struct script_state *st, struct map_session_data *sd, const char *varname, int elem, void *value, struct reg_db *ref)
{
