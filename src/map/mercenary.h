...
public:
	...
	static struct s_mercenary_db *db;
	...
	static int data_received (struct s_mercenary *merc, bool flag);
	static int save (struct mercenary_data *md);

	static void heal (struct mercenary_data *md, int hp, int sp);
	static int dead (struct mercenary_data *md);

	static int _delete (struct mercenary_data *md, int reply);
	static void contract_stop (struct mercenary_data *md);

	static int get_lifetime (struct mercenary_data *md);
	static int get_guild (struct mercenary_data *md);
	static int get_faith (struct mercenary_data *md);
	static int set_faith (struct mercenary_data *md, int value);
	static int get_calls (struct mercenary_data *md);
	static int set_calls (struct mercenary_data *md, int value);
	static int kills (struct mercenary_data *md);

	static int checkskill (struct mercenary_data *md, uint16 skill_id);
	static int read_db (void);
	static int read_skilldb (void);

	static int killbonus (struct mercenary_data *md);
	static int search_index (int class_);

	static int contract_end_timer (int tid, int64 tick, int id, intptr_t data);
	static bool read_db_sub (char* str[], int columns, int current);
	static bool read_skill_db_sub (char* str[], int columns, int current);
};
extern CMercenary  *mercenary;
